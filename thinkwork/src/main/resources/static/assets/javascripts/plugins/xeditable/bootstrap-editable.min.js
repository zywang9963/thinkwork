    ...
    $.fn.editableutils = {
        ...
        createInput: function(options) {
            ...
            if(type === 'date') {
                ...
                //if type still `date` and not exist in types, replace with `combodate` that is jpa input
...
/**
 AbstractInput - jpa class for all editable inputs.
 ...
 * range
 ...
 @since 1.3.0
 @example
 <a href="#" id="email" data-type="email" data-pk="1">administration@example.com</a>
 <script>
 $(function(){
    $('#email').editable({
        url: '/post',
